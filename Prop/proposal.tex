...
\tikzstyle{g}=[node distance=1.0cm] 
\tikzstyle{v}=[circle,draw=black!100,fill=blue!10,minimum
size=4mm,inner sep=0] 
\tikzstyle{bigarrow}=[line width=1.5pt,>=angle 45,line
cap=round,black!100]

\newcommand{\ntext}{\scriptsize}
\newcommand{\etext}{\scriptsize}
...
\newcommand{\mytitle}{Language Support for Resource-Savvy Synthesis}
\newcommand{\myname}{Fisher \& Walker}
...
\begin{centering}
\section*{{\Large CCF:Small:Collaborative Research: \\ 
