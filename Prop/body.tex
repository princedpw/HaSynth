...
beginning.  High-quality code also needs to make savvy use of resources.
In modern computer systems, there are many implementation
choices, and the best choice depends upon many factors that may be
only poorly understood by programmers.  Examples of such factors
include the difficult-to-predict effects of 
hardware and/or software caches, 
jit compilers, 
the changing needs of dynamic workloads, and
...
not available until the library is used.  Exposing different API
calls, for example as Haskell's JSON parsing library does, is a
brittle and clumsy mechanism for allowing users to customize
performance. 
