...
ramifications for their code.  However, we propose to allow users to declare symbolic types for their
data structures and to allow the system to search for optimal representatives for them.  For example,
looking again at Figure~\ref{fig:type-class-set} ...
...
-- function using a set
process :: Set s => s a -> a -> s a
process = ...
...
component n =
  process (empty size* :: t* int)   -- Symbolic type class for sets of integers
  ...                               -- Initial size symbolic
