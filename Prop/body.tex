...
\begin{figure}[h]
  ...
  \begin{minipage}{.45\textwidth}
    ...
    \end{tikzpicture}
    \captionof{figure}{Possible representations for weighted graph edges.  Solid edges
  ...
  \begin{minipage}{.45\textwidth}
    ...
    \captionof{figure}{\label{fig:rasp}A proposed visual element template for a load
