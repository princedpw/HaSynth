...
In addition to supporting several strategies independently, we will have have
...
The \cd{VULNERABILITIES} pragma instructs the system to help users uncover potential
